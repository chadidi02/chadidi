			...
			<div class=" flex flex-wrap absolute left-0 right-0 my-16 md:my-40 mx-12">
				<div class="w-full md:w-1/2 h-full">
					<div class="md:flex rounded-lg pt-6">
						<div class=" h-32 w-32 md:h-40 md:w-40  mx-auto md:mx-0 md:mr-10 "> 
							<img class="w-full h-full rounded-full" src="${basics.picture}"/>
						</div>
						<div class="text-center md:text-left">
							...
							<div class=" my-1">
								<a href="mailto:s.chadidi02@gmail" class="text-gray-200 text-base">${basics.email}</a></div>
							<div class=" my-1">
